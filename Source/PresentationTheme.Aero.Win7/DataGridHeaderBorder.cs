    ...
    public sealed class DataGridHeaderBorder : Border
    {
        static DataGridHeaderBorder()
        {
            ...
            SnapsToDevicePixelsProperty.OverrideMetadata(
                typeof(DataGridHeaderBorder), new FrameworkPropertyMetadata(true));
        }

        #region Header Appearance Properties

        /// <summary>Whether the hover look should be applied.</summary>
        ...
        /// <summary>DependencyProperty for IsHovered.</summary>
        ...
        /// <summary>Whether the pressed look should be applied.</summary>
        ...
        /// <summary>DependencyProperty for IsPressed.</summary>
        ...
        /// <summary>
        ///   When false, will not apply the hover look even when IsHovered is
        ///   true.
        /// </summary>
        ...
        /// <summary>DependencyProperty for IsClickable.</summary>
        ...
        /// <summary>Whether to appear sorted.</summary>
        ...
        /// <summary>DependencyProperty for SortDirection.</summary>
        ...
        /// <summary>Whether to appear selected.</summary>
        ...
        /// <summary>DependencyProperty for IsSelected.</summary>
        ...
        /// <summary>Vertical = column header Horizontal = row header</summary>
        ...
        /// <summary>DependencyProperty for Orientation.</summary>
        ...
        /// <summary>
        ///   Property that indicates the brush to use when drawing seperators
        ///   between headers.
        /// </summary>
        ...
        /// <summary>DependencyProperty for SeparatorBrush.</summary>
        ...
        /// <summary>DependencyProperty for SeperatorBrush.</summary>
        ...
        /// <summary>Called when this element should re-render.</summary>
