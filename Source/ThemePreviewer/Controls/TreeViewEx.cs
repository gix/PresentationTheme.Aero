        ...
        protected override void WndProc(ref Message m)
        {
            if (m.Msg == NativeMethods.WM_CREATE) {
                if (UseExplorerStyle) {
                    ...
                    //var int32 = NativeMethods.SendMessage(Handle, 0x112d, IntPtr.Zero, IntPtr.Zero).ToInt32();
                    //NativeMethods.SendMessage(Handle, 0x112c, IntPtr.Zero, (IntPtr)(int32 | 0x60));
                }
            }
